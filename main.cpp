...
void RenderScene(void){ 
	...
	Print->Face(malha->getCell(10), red);
	Print->Face(malha->getCell(0)(malha->getCell(0))->getMateId(0)),blue));
	Print->Face(malha->getCell(10)->getMateId(malha->getCell(10)->getVertexIndex(1)),grey));
...
int main(int *argc, char **argv)
{
  ...
  Interactor->setDraw(RenderScene);
	meshHandler.Set(new TMesh());
      char *fileBrasil = "/home/bianca/git/mvga/Brasil.off";
